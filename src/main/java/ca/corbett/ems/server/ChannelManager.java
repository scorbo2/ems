...
public class ChannelManager {
    ...
    /**
     * Unsubscribes the given client from all channels to which it was subscribed (except for the
     * special channel ALL which cannot be unsubscribed).
     *
     * @param clientId The client in question.
     */
    public void unsubscribeFromAll(String clientId) {
