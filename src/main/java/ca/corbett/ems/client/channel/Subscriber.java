package ca.corbett.ems.client.channel;
...
/**
 * An implementation of EMSClient specifically for subscribing to channels to send
 * and receive messages on those channels. For a more basic client implementation
 * that just focuses on sending raw commands, see EMSClient instead.
 * <p>
